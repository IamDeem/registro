...
$areaTrabajo = $_POST['areaTrabajo'] => 'Departamento',$op= $_POST['op'] => 'lugar',$pago= $_POST['pago'] => 'Sueldo');

$trabajo2 = array($name2 = $_POST['name2'] =>'Nombre',$ape2 = $_POST['ape2'] => 'Apellido',$cedula2 = $_POST['cedula2'] => 'C.I',
$areaTrabajo2 = $_POST['areaTrabajo2'] => 'Departamneto',$op2 = $_POST['op2'] => 'lugar',$pago2 = $_POST['pago2'] => 'sueldo');


$trabajo3 = array($name3 = $_POST['name3'] => 'Nombre',$ape3 = $_POST['ape3'] => 'Apellido',$cedula3 = $_POST['cedula3'] => 'C.I',
$areaTrabajo3 = $_POST['areaTrabajo3'] => 'Departamento',$op3 = $_POST['op3'] => 'lugar',$pago3 = $_POST['pago3'] =>'Sueldo');
